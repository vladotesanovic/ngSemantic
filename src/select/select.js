...
var SemanticSelectComponent = (function () {
    ...
    SemanticSelectComponent.prototype.ngAfterViewInit = function () {
        ...
        var options = Object.assign({
            ...
            onHide: function () {
                _this.control.markAsTouched();
                if (_this.select.nativeElement.value === "") {
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", String)
    ], SemanticSelectComponent.prototype, "required", void 0);
    __decorate([
    ...
    SemanticSelectComponent = __decorate([
        core_1.Component({
            ...
            selector: "sm-select",
            template: "<div class=\"field\" [ngClass]=\"{error: (!control?.pristine && control?.invalid), 'required': required}\">\n  <label *ngIf=\"label\">{{label}}</label>\n<select [formControl]=\"control\" class=\"ui {{class}} dropdown\"  #select>\n    <option value=\"\">{{placeholder}}</option>\n    <ng-content></ng-content>\n</select>\n</div>"
        })
