...
import {ErrorCheckFunction} from "../../../../src/progress/progress";
...
@Component({
    ...
    template: `
      ...
      <div class="main ui container">
        ...
        <sm-progress class="blue" [progress]="percent" [errorCheckFn]="findErrorAt50Percent"></sm-progress>
...
export class ProgressComponent {
    ...
    findErrorAt50Percent: ErrorCheckFunction = (): boolean => {
